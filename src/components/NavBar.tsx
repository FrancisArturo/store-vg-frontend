						...
						<div>
							...
							<div className="flex justify-end">
								<>
									<svg
										aria-hidden="true"
										className="inline w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300 ml-3 absolute bottom-1 right-1"
										viewBox="0 0 100 101"
										fill="none"
								...
								<div>
									{productsFound.map((product) => (
										<a
											...
											href={`http://localhost:5173/product/${product.sku}`}
										>
